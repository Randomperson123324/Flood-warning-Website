...
const translations = {
  en: {
    ...
    weather: {
      ...
      forecastDescription: "Forecast for the upcoming days that may affect water level",
  ...
  th: {
    ...
    weather: {
      ...
      forecast: "พยากรณ์รายวัน",
      hourlyForecast: "พยากรณ์รายชั่วโมง",
      forecastDescription: "สภาพอากาศในวันข้างหน้าที่อาจส่งผลต่อระดับน้ำ",
    ...
    warningScreen: {
      ...
      agreement: "ฉันเข้าใจว่า หมูแดดเดียว จะไม่รับผิดชอบต่อความเสียหายใดๆ ที่เกิดขึ้นจากการที่ฉันไม่ปฏิบัติตามคำแนะนำดังกล่าว",
      continue: "ฉันเข้าใจ",
    },
  },
}
