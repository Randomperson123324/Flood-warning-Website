          ...
          <LoadingOverlay isLoading={isFirstLoad}>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-6">
              ...
              {(() => {
                ...
                if (diffInMinutes > 7) {
                  return (
                    <div className="bg-yellow-100 border-l-4 rounded-tl-full rounded-tr-full rounded-bl-none rounded-br-full shadow-sm animate-in fade-in slide-in-from-top-2 duration-500">
